...
export const metadata = {
  title: 'Privacy Policy | London Dog Groomers',
  description: 'Privacy policy for using the London Dog Groomers service',
};
  ...
  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto prose prose-blue">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Privacy Policy for Dog Groomers in London</h1>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Types of Data Collected</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Tracking Technologies and Cookies</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Use of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Delete Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">Security of Your Personal Data</h3>
